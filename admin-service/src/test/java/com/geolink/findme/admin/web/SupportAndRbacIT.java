package com.geolink.findme.admin.web;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.geolink.findme.admin.AbstractIntegrationTest;
...
/**
 * Tests d'intégration du support client et du RBAC de l'admin-service (cahier des charges §2.3, §2.4) :
 * formulaire public de support (sans auth) → 201, liste support réservée ADMIN/SUPPORT_AGENT,
 * liste utilisateurs réservée ADMIN (un USER ou SUPPORT_AGENT → 403, anonyme → 401).
 */
